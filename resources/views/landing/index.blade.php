...
<section id="services" class="services section light-background">
    ...
    <div class="container">
        <div class="row gy-4">
            @foreach (['Lorem Ipsum', 'Sed ut perspici', 'Magni Dolores', 'Nemo Enim'] as $index => $service)
            <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="{{ ($index + 1) * 100 }}">
                <div class="service-item position-relative">
                    <div class="icon"><i class="bi bi-{{ ['activity', 'bounding-box-circles', 'calendar4-week', 'broadcast'][$index] }} icon"></i></div>
