...
<html lang="en">
  <head>
    ...
    <link
      rel="icon"
      href="{{ asset('admin/assets/assets/img/kaiadmin/favicon.ico')}}"
      type="image/x-icon"
    />
                      ...
                      <div class="message-notif-scroll scrollbar-outer">
                        <div class="notif-center">
                          <a href="#">
                            <div class="notif-img">
                              <img
                                src="{{ asset('admin/assets/assets/img/jm_denis.jpg') }}"
                                alt="Img Profile"
                              />
                            </div>
                          ...
                          <a href="#">
                            <div class="notif-img">
                              <img
                                src="{{ asset('admin/assets/assets/img/chadengle.jpg') }}"
                                alt="Img Profile"
                              />
                            </div>
                            <div class="notif-content">
                          ...
                          <a href="#">
                            <div class="notif-img">
                              <img
                                src="{{ asset('admin/assets/assets/img/mlane.jpg') }}"
                                alt="Img Profile"
                              />
                            </div>
                            <div class="notif-content">
                          ...
                          <a href="#">
                            <div class="notif-img">
                              <img
                                src="{{ asset('admin/assets/assets/img/talha.jpg') }}"
                                alt="Img Profile"
                              />
                            </div>
                            <div class="notif-content">
                      ...
                      <div class="notif-scroll scrollbar-outer">
                        <div class="notif-center">
                          ...
                          <a href="#">
                            <div class="notif-img">
                              <img
                                src="{{ asset('admin/assets/assets/img/profile2.jpg') }}"
                                alt="Img Profile"
                              />
                            </div>
                            <div class="notif-content">
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="card card-secondary bg-secondary-gradient">
                  <div class="card-body skew-shadow">
                    <img
                      src="{{ asset('admin/assets/assets/img/visa.svg') }}"
                      height="12.5"
                      alt="Visa Logo"
                    />
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="card card-post card-round">
                  <img
                    class="card-img-top"
                    src="{{ asset('admin/assets/assets/img/blogpost.jpg') }}"
                    alt="Card image cap"
                  />
                  <div class="card-body">
                    <div class="d-flex">
              ...
              <div class="col-md-4">
                <div class="card card-profile">
                  <div
                    class="card-header"
                    style="background-image: url('{{ asset('admin/assets/assets/img/blogpost.jpg') }}')"
                  >
